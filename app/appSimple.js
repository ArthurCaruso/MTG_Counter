...
minusFiveP1.addEventListener('click', function(){
    ...
    p1hpVar1stBlkUp.innerHTML = p1CurrentVarLogic
    p2hpVar1stBlkDown.innerHTML = p1CurrentVarLogic
})
...
minusFiveP2.addEventListener('click', function(){
    ...
    p2hpVar1stBlkUp.innerHTML = p2CurrentVarLogic
    p1hpVar1stBlkDown.innerHTML = p2CurrentVarLogic
})
...
passPlayerOne.addEventListener('click', function(){
    ...
    p2hpVar1stBlkUp.innerHTML = '0'
    p2hpVar1stBlkDown.innerHTML = '0'   
    p1hpVar1stBlkUp.innerHTML = '0' 
    p1hpVar1stBlkDown.innerHTML = '0' 
})
